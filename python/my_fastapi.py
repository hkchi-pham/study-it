...
#query parameter
@app.get("/get-by-name/{student_id}") #combining path + query
...
def create__student(student_id:int, student : Student):
...
def delete_student(student_id: int):
    if student_id not in students:
        return {"Error": "Student does not exist in database"}
    
    del students[student_id]
    return {"Update": "Student delete successfully"}
